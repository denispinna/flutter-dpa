          ...
          Padding(
            ...
            child: CenterHorizontal(RichText(
              text: TextSpan(
                ...
                children: <TextSpan>[
                  TextSpan(text: AppLocalizations.of(context).translate('no_account_message')),
                  TextSpan(
                      text: AppLocalizations.of(context).translate('sign_up'), style: TextStyle(fontWeight: FontWeight.bold),
                      recognizer: new TapGestureRecognizer()..onTap = () => Navigator.pushNamed(context, '/sign_up')
                  ),
                ],
              ),
            )),
